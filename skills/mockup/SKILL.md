...
保存先: `aidlc-docs/mockups/screen_inventory.md`
...
**成果物登録・コミット:** 画面一覧を manifest.md に登録し、prompts.md に記録してコミットする。
コミット: `aidlc(mockup): step1 画面一覧作成`
...
**成果物登録・コミット:** 画面遷移図を manifest.md に登録し、prompts.md に記録してコミットする。
コミット: `aidlc(mockup): step2 画面遷移図作成`
...
**成果物登録・コミット:** 承認されたモックアップとフィードバックを manifest.md に登録し、prompts.md に記録してコミットする。
画面数が多い場合は数画面ごとにまとめてコミットしてよい。
コミット: `aidlc(mockup): step3 UIモックアップ {画面ID群}`
...
**成果物登録・コミット:** インタラクション仕様を manifest.md に登録し、prompts.md に記録してコミットする。
コミット: `aidlc(mockup): step4 インタラクション仕様`
...
**成果物登録・コミット:** レビュー結果を manifest.md に登録し、prompts.md に記録してコミットする。
コミット: `aidlc(mockup): step5 横断レビュー`
...
**成果物登録・コミット:** サマリーを manifest.md に登録し、
全成果物が manifest.md に漏れなく登録されていることを最終確認する。
prompts.md に記録してコミットする。
コミット: `aidlc(mockup): step6 サマリー出力・完了`
...
コミットメッセージ規約: `aidlc(mockup): step{N} {概要}`
